    ...
    public static void main(String[] args) {
        ...
        do {
            try {
                op = input.nextInt();
                switch (op) {
                    case 1 -> roomAirConditioner.on();
                    case 2 -> roomAirConditioner.off();
                    case 3 -> livingAirConditioner.on();
                    case 4 -> livingAirConditioner.off();
                    case 5 -> roomLight.on();
                    case 6 -> roomLight.off();
                    case 7 -> livingLight.on();
                    case 8 -> livingLight.off();
